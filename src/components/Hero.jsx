    ...
    return (
        <section className="w-full bg-gradient-to-r from-black via-blue-950 to-black rounded-b-3xl px-10 py-20">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
                ...
                <div
                    className={`flex-1 transition-all duration-1000 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
                        }`}
                >
                    <div className="max-w-xl mx-auto md:ml-auto text-center md:text-right">
                        ...
                        <button
                            className={`bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg font-medium transition-transform duration-700 ${show ? "scale-100" : "scale-90"
                                }`}
                        >
                            Get Started →
                        </button>
